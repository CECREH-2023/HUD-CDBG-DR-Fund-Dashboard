#!/usr/bin/env python3
"""Create the processed financial/geographic file used by the static dashboard.
...
county, city/place, and urban-area matching work. Only financial and geographic inputs are read.
